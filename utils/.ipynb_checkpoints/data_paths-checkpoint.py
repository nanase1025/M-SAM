img_datas1 = ['data/train/brats20_flair']
img_datas = ['data/test/ct_beizhong']
val_datas = ['data/test/ct_beizhong']
# data/train/full20_flair
# 'data/train/beizhong_ct'
# 'data/train/brats20_flair'
# # 新加一个地址的时候别忘了加逗号，要不然无法成功注册
# img_datas = [
# # 'data/train/brats20_flair',
# # 'data/train/edema/mr_flair_BraTS2021',
...
# ]
# val_datas = ['data/test/brats20_test']
# all_classes = [
# 'COVID_lesion',
# 'adrenal',
# 'adrenal_gland_left',
